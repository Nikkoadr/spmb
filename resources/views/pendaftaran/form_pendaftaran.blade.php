...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="https://wa.me/6281122207770" class="nav-link">Kontak</a></li>
...
<div class="content-wrapper">
    <div class="content-header text-center">
        <h1 class="m-0 mb-3 text-primary">Formulir Penerimaan Peserta Didik Baru (SPMB)</h1>
        <h5 class="text-muted">Tahun Ajaran <b>{{ $periode->tahun_ajaran }}</b></h5>
    </div>
                    ...
                    <div class="card bg-white p-4 shadow-sm">
                        <form action="/proses_pendaftaran" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('nisn') is-invalid @enderror" id="nisn" name="nisn" placeholder="Masukkan NISN" value="{{ old('nisn') }}">
                                    @error('nisn')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('no_kk') is-invalid @enderror" id="no_kk" name="no_kk" placeholder="Masukkan No KK" value="{{ old('no_kk') }}">
                                    @error('no_kk')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('no_nik') is-invalid @enderror" id="no_nik" name="no_nik" placeholder="Masukkan No NIK" value="{{ old('no_nik') }}">
                                    @error('no_nik')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input oninput="this.value = this.value.toUpperCase()"  id="nik_ayah" type="number" class="form-control @error('nik_ayah') is-invalid @enderror" name="nik_ayah" value="{{ old('nik_ayah') }}" placeholder="NIK Ayah Kandung">
                                        @error('nik_ayah')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input oninput="this.value = this.value.toUpperCase()"  id="nik_ibu" type="number" class="form-control @error('nik_ibu') is-invalid @enderror" name="nik_ibu" value="{{ old('nik_ibu') }}" placeholder="NIK Ibu Kandung">
                                        @error('nik_ibu')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
<footer class="main-footer text-center">
    <strong>&copy; 2020–2030 <a href="#">Nikko Adrian</a>.</strong> All rights reserved.
</footer>
</div>
