...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <h3 class="card-title">Form Edit Asal Sekolah</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form action="/databases/update_asal_sekolah/{{ $data_asal_sekolah->id }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                    <label for="npsn" class="col-md-2 col-form-label text-md-right">NPSN :</label>
                        <div class="col-md-10">
                            <input type="number" class="form-control" id="npsn" name="npsn" value="{{ $data_asal_sekolah->npsn }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="id_jenis_asal_sekolah" id="id_jenis_asal_sekolah">
                                ...
                                @foreach ($jenis_asal_sekolah as $row)
                                    <option value="{{ $row->id }}" {{ $data_asal_sekolah->id_jenis_asal_sekolah == $row->id ? 'selected' : '' }}>{{ $row->nama_jenis_asal_sekolah }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="id_status_asal_sekolah" id="id_status_asal_sekolah">
                                ...
                                @foreach ($status_asal_sekolah as $row)
                                    <option value="{{ $row->id }}" {{ $data_asal_sekolah->id_status_asal_sekolah == $row->id ? 'selected' : '' }}>{{ $row->nama_status_asal_sekolah }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <label for="nama_asal_sekolah" class="col-md-2 col-form-label text-md-right">Nama Asal Sekolah :</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="nama_asal_sekolah" name="nama_asal_sekolah" value="{{ $data_asal_sekolah->nama_asal_sekolah }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    <label for="kecamatan" class="col-md-2 col-form-label text-md-right">Kecamatan :</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="{{ $data_asal_sekolah->kecamatan }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    <label for="kabupaten" class="col-md-2 col-form-label text-md-right">Kabupaten :</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="kabupaten" name="kabupaten" value="{{ $data_asal_sekolah->kabupaten }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    <label for="provinsi" class="col-md-2 col-form-label text-md-right">Provinsi :</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="provinsi" name="provinsi" value="{{ $data_asal_sekolah->provinsi }}" required>
                        </div>
                    </div>
                        <div class="col-12">
